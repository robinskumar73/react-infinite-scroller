...
var InfiniteScroll = (function(_Component) {
  ...
  function InfiniteScroll(props) {
    ...
    _this.isWindowScrolledToBottom = function() {
      if (typeof window !== 'undefined') {
        var currentHeight = (0, _get2.default)(document, 'body.scrollHeight')
          ? (0, _get2.default)(document, 'body.scrollHeight')
          : (0, _get2.default)(document, 'documentElement.scrollHeight');
        // @var int scrollPoint
                ...
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 14:
                      ...
                      this.showLoadingbar();
                      if (this.props.useWindow) {
                        this.beforeScrollHeight = (0, _get2.default)(
                          document,
                          'body.scrollHeight'
                        )
                          ? (0, _get2.default)(document, 'body.scrollHeight')
